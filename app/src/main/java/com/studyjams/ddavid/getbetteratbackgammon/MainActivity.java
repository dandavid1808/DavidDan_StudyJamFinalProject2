...
public class MainActivity extends ActionBarActivity {
    ...
    private void displayMessage10(String message) {
        ...
        TextView failTextView = (TextView) findViewById(R.id.fail_text_view);
    ...
    private void displayMessage2(String message) {
        ...
        TextView firstExercise = (TextView) findViewById(R.id.firstExerciseRequest_text_view);
        String question = "Because you said you learned the basic rules of the game you will be tested with a little quiz. Are you ready?";
        firstExercise.setVisibility(View.VISIBLE);
        firstExercise.setText(question);
        Button BeginExerciseButton = (Button) findViewById(R.id.beginExercise_button_view);
        BeginExerciseButton.setVisibility(View.VISIBLE);
    }
